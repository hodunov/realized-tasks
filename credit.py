...
общая сумма плятежа за данный месяц |
"""
...
credit.add_column("Общая сумма плятежа", [round(num, 2) for num in result_payment])
...
+-------+--------------------+--------------------------+----------------------------+---------------------+
| Месяц | Остаток по кредиту | Сумма платежа по кредиту | Сумма платежа по процентам | Общая сумма плятежа |
+-------+--------------------+--------------------------+----------------------------+---------------------+
